...
\begin{frame}
 \centering
\only<1>{\includegraphics[height=8.25cm]{fT}\\}
\end{frame}
...
\begin{frame}
 ...
 \centering
\only<1>{\includegraphics[height=8.25cm]{f0}\\}
\end{frame}

\begin{frame}
 \frametitle{What's the purpose of the GUI? (2)}
 \centering
\only<1>{\includegraphics[height=8.25cm]{f0other}\\}
\end{frame}
...
% \centering
%\only<1>{\includegraphics[height=8.25cm]{f0other2}\\}
%\end{frame}
...
\begin{frame}
 ...
 \centering
\only<1>{\includegraphics[height=8.25cm]{f1a}\\}
\only<2>{\includegraphics[height=8.25cm]{f1b}\\}
\end{frame}
...
% \frametitle{Menus...}
%\centering
%\only<1>{\includegraphics[height=8.25cm]{f6a}\\}
%\only<2>{\includegraphics[height=8.25cm]{f6b}\\}
%\only<3>{\includegraphics[height=8.25cm]{f6c}\\}
%\only<4>{\includegraphics[height=8.25cm]{f6d}\\}
%\end{frame}
...
\centering
\only<1>{\includegraphics[height=8.25cm]{f7a}\\}
\only<2>{\includegraphics[height=8.25cm]{f7b}\\}
\only<3>{\includegraphics[height=8.25cm]{f7a_bis}\\}
\only<4>{\includegraphics[height=8.25cm]{f7a_bis2}\\}
\end{frame}
...
%\centering
%\only<1>{\includegraphics[height=8.25cm]{f8a}\\}
%\end{frame}
...
%\centering
%\only<1>{\includegraphics[height=8.25cm]{f9}\\}
%\end{frame}
...
% \centering
% \only<1>{\includegraphics[height=8.25cm]{f10}\\}
%\end{frame}
...
\begin{frame}
 ...
 \centering
 \only<1>{\includegraphics[height=8.25cm]{f11}\\}
\end{frame}

\begin{frame}
 \frametitle{Perspectives}
 \centering
 \only<1>{\includegraphics[height=8.25cm]{f12}\\}
\end{frame}

\begin{frame}
 \frametitle{Many thanks to:}
 \centering
 \only<1>{\includegraphics[height=8.25cm]{f13}\\}
\end{frame}
